    ...
    return (
        <Container paddingBottom={false}>
            ...
            <View style={styles.categoriesWrapper}>
                {
                    categories.map(el => 
                        <TouchableOpacity style={styles.categoriesWrapperItem} key={el.id} onPress={() => navigation.navigate('Search_List')}>
                            <Image source={{uri: el.photo}} style={styles.categoriesWrapperItemImage}/>
                            <View style={styles.categoriesWrapperItemGradientBox}>
                                <Svg height="100%" width="100%" style={styles.categoriesWrapperItemGradient}>
                                    <Defs>
